 ...
 */
@Controller
public class UnionVerificationController
{
    ...
    @RequestMapping(value = "/unionVerification", method = RequestMethod.GET)
    public String getAuditingPage(Model model, HttpServletRequest request, HttpSession session)
    {
        ...
        return "unionVerification";
    }

    @RequestMapping(value = "/unionVerification/list", method = RequestMethod.POST)
    public @ResponseBody
    void paginationUnionVerification(HttpServletRequest request, HttpServletResponse response)
    {
        //Fetch the page number from client
        System.out.println("in unionVerification pagination controller");
...
//                null, false, null, false, applicationStatusList, true, divisionId, divisionId != null, districtId, districtId != null, upazilaId, upazilaId != null, unionId, unionId != null, beginIndex, pageSize);
    ...
    @RequestMapping(value = "/unionVerification", method = RequestMethod.POST)
            ...
            HttpServletRequest request, RedirectAttributes redirectAttributes)
    {
        ...
        ControllerMessage controllerMessage = new ControllerMessage(ControllerMessageType.SUCCESS, localizer.getLocalizedText("approveUnionChairmanVerification", LocaleContextHolder.getLocale()));
        ...
        return "redirect:/unionVerification";
    }

    @RequestMapping(value = "/unionVerificationReport", method = RequestMethod.POST)
            ...
            HttpServletRequest request, RedirectAttributes redirectAttributes, HttpServletResponse response) throws ColumnBuilderException, ClassNotFoundException, JRException, IOException
    {
        ...
        System.out.println("Selected applicant list for print= " + selectedApplicantList);
        if (!"".equals(selectedApplicantList))
        {
            //approved (selected only) applicants status update here
            Map parameter = new HashMap();
            parameter.put("selectedApplicantList", selectedApplicantList.substring(0, selectedApplicantList.length() - 1));
            System.out.println("converted string " + selectedApplicantList.substring(0, selectedApplicantList.length() - 1));
    ...
    private DynamicReport getApplicantDetailDynamicReport(ApplicantReportData applicantReportData) throws ColumnBuilderException, ClassNotFoundException
    {
        try
        {
            ...
            String beneficiaryReport = localizer.getLocalizedText("label.unionApproval", locale);
