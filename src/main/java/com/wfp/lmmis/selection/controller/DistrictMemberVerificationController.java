 ...
 */
@Controller
public class DistrictMemberVerificationController
{
    ...
    @RequestMapping(value = "/districtMemberVerification", method = RequestMethod.GET)
    public String getAuditingPage(Model model, HttpServletRequest request, HttpSession session)
    {
        ...
        return "districtMemberVerification";
    }
     ...
     * @param response
     */
    @RequestMapping(value = "/districtMemberVerification/list", method = RequestMethod.POST)
    public @ResponseBody
    void paginationUnionVerification(HttpServletRequest request, HttpServletResponse response)
    {
        //Fetch the page number from client
        System.out.println("in districtMemberVerification pagination controller");
...
//                ja.put((applicant.getFirstNameInBangla() == null ? ' ' : applicant.getFirstNameInBangla()) + " " + (applicant.getMiddleNameInBangla() == null ? ' ' : applicant.getMiddleNameInBangla()) + " " + (applicant.getLastNameInBangla() == null ? ' ' : applicant.getLastNameInBangla()));
    ...
    @RequestMapping(value = "/districtMemberVerification", method = RequestMethod.POST)
            ...
            HttpServletRequest request, RedirectAttributes redirectAttributes)
    {
        ...
        parameter.put("beforeApplicationStatus", ApplicationStatus.DISTRICT_MEMBER_LEVEL_VERIFICATION);
        parameter.put("afterApplicationStatus", ApplicationStatus.DISTRICT_PRESIDENT_LEVEL_VERIFICATION);
        String selectedApplicantList = applicantService.updateApplicantStatus(parameter);
        ControllerMessage controllerMessage = new ControllerMessage(ControllerMessageType.SUCCESS, localizer.getLocalizedText("approveDistrictMemberVerification", LocaleContextHolder.getLocale()));
        ...
        return "redirect:/districtMemberVerification";
    }

    @RequestMapping(value = "/districtMemberVerificationReport", method = RequestMethod.POST)
    ...
    private DynamicReport getApplicantDetailDynamicReport(ApplicantReportData applicantReportData) throws ColumnBuilderException, ClassNotFoundException
    {
        try
        {
            ...
            String beneficiaryReport = localizer.getLocalizedText("label.districtMemberApproval", locale);
