 ...
 */
@Controller
public class BGMEARepresentativeVerificationController
{
    ...
    @RequestMapping(value = "/bgmeaRepresentativeVerification", method = RequestMethod.GET)
    public String getAuditingPage(Model model, HttpServletRequest request, HttpSession session)
    {
        ...
        return "bgmeaRepresentativeVerification";
    }
     ...
     * @param response
     */
    @RequestMapping(value = "/bgmeaRepresentativeVerification/list", method = RequestMethod.POST)
    public @ResponseBody
    void paginationUnionVerification(HttpServletRequest request, HttpServletResponse response)
    {
        //Fetch the page number from client
        System.out.println("in bgmeaRepresentativeVerification pagination controller");
...
//                ja.put((applicant.getFirstNameInBangla() == null ? ' ' : applicant.getFirstNameInBangla()) + " " + (applicant.getMiddleNameInBangla() == null ? ' ' : applicant.getMiddleNameInBangla()) + " " + (applicant.getLastNameInBangla() == null ? ' ' : applicant.getLastNameInBangla()));
    ...
    @RequestMapping(value = "/bgmeaRepresentativeVerification", method = RequestMethod.POST)
            ...
            HttpServletRequest request, RedirectAttributes redirectAttributes)
    {
        ...
        parameter.put("beforeApplicationStatus", ApplicationStatus.BGMEA_REPRESENTITIVE_LEVEL_VERIFICATION);
        ...
        return "redirect:/bgmeaRepresentativeVerification";
    }

    @RequestMapping(value = "/bgmeaRepresentativeVerificationReport", method = RequestMethod.POST)
    ...
    private DynamicReport getApplicantDetailDynamicReport(ApplicantReportData applicantReportData) throws ColumnBuilderException, ClassNotFoundException
    {
        try
        {
            ...
            String beneficiaryReport = localizer.getLocalizedText("label.bgmeaRepresentativeApproval", locale);
