 ...
 */
@Controller
public class UpazilaPresidentVerificationController
{
     ...
     * @return
     */
    @RequestMapping(value = "/upazilaPresidentVerification", method = RequestMethod.GET)
    public String getAuditingPage(Model model, HttpServletRequest request, HttpSession session)
    {
        ...
        return "upazilaPresidentVerification";
    }

    @RequestMapping(value = "/upazilaPresidentVerification/list", method = RequestMethod.POST)
    public @ResponseBody
    void paginationUnionVerification(HttpServletRequest request, HttpServletResponse response)
    {
        //Fetch the page number from client
        System.out.println("in upazilaPresidentVerification pagination controller");
        ...
        applicationStatusList.add(ApplicationStatus.UPAZILA_PRESIDENT_LEVEL_VERIFICATION);
...
//                ja.put((applicant.getFirstNameInBangla() == null ? ' ' : applicant.getFirstNameInBangla()) + " " + (applicant.getMiddleNameInBangla() == null ? ' ' : applicant.getMiddleNameInBangla()) + " " + (applicant.getLastNameInBangla() == null ? ' ' : applicant.getLastNameInBangla()));
            ...
            HttpServletRequest request, RedirectAttributes redirectAttributes)
    {
        ...
        parameter.put("beforeApplicationStatus", ApplicationStatus.UPAZILA_PRESIDENT_LEVEL_VERIFICATION);
    ...
    @RequestMapping(value = "/upazilaPresidentVerificationReport", method = RequestMethod.POST)
    ...
    private DynamicReport getApplicantDetailDynamicReport(ApplicantReportData applicantReportData) throws ColumnBuilderException, ClassNotFoundException
    {
        try
        {
            ...
            String beneficiaryReport = localizer.getLocalizedText("label.upazilaPresidentApproval", locale);
            ...
            {
                drb.addFirstPageImageBanner("image/banner_bn3.png", 272, 60, ImageBanner.ALIGN_CENTER);
            }
            else
            {
