 ...
 */
@Controller
public class DistrictPresidentVerificationController
{
    ...
    @RequestMapping(value = "/districtPresidentVerification", method = RequestMethod.GET)
    public String getAuditingPage(Model model, HttpServletRequest request, HttpSession session)
    {
        ...
        return "districtPresidentVerification";
    }
     ...
     * @param response
     */
    @RequestMapping(value = "/districtPresidentVerification/list", method = RequestMethod.POST)
    public @ResponseBody
    void paginationUnionVerification(HttpServletRequest request, HttpServletResponse response)
    {
        //Fetch the page number from client
        System.out.println("in districtPresidentVerification pagination controller");
        ...
        applicationStatusList.add(ApplicationStatus.DISTRICT_PRESIDENT_LEVEL_VERIFICATION);
...
//                ja.put((applicant.getFirstNameInBangla() == null ? ' ' : applicant.getFirstNameInBangla()) + " " + (applicant.getMiddleNameInBangla() == null ? ' ' : applicant.getMiddleNameInBangla()) + " " + (applicant.getLastNameInBangla() == null ? ' ' : applicant.getLastNameInBangla()));
     ...
     * @return
     */
    @RequestMapping(value = "/districtPresidentVerification", method = RequestMethod.POST)
            ...
            HttpServletRequest request, RedirectAttributes redirectAttributes)
    {
        ...
        parameter.put("beforeApplicationStatus", ApplicationStatus.DISTRICT_PRESIDENT_LEVEL_VERIFICATION);
        ...
        return "redirect:/districtPresidentVerification";
    }
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/districtPresidentVerificationReport", method = RequestMethod.POST)
    ...
    private DynamicReport getApplicantDetailDynamicReport(ApplicantReportData applicantReportData) throws ColumnBuilderException, ClassNotFoundException
    {
        try
        {
            ...
            String beneficiaryReport = localizer.getLocalizedText("label.districtPresidentApproval", locale);
