...
SELECT 1,'উপজেলা কর্মকর্তা',CONCAT('uwao.',LOWER(u.name_in_english),'@gmail.com') ,
...
'3a8f99e9e744de26c8e75270a9016a499c3a1dfad9749854e6e5573718a3b8081591b33542bd73f80094d54426200d372bbc27886d6e5afde3d1032ab9054a89',
 CONCAT('uwao.',REPLACE( LOWER(u.name_in_english),' ','') ),'','7QP59L/vmZoZKAVkiGnYUwyN2+8=',b'0',u.district_id, di.id, 8, 3,NULL,u.id,0,2,2,SYSDATE(),NULL,1,null
...
SELECT  b'0', b'0', b'0', b'0', 2, u.district_id, u.division_id, 28 roleId, 3 scheme_id, NULL, u.upazilla_id, NULL bgmea_factory_id, NULL bkmea_factory_id, u.id, SYSDATE() creation_date FROM user u 
WHERE u.id>=9893;
