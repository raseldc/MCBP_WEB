...
<script>
    ...
    $(function () {
        ...
        if ('${searchParameterForm.isDistrictAvailable}' === 'false' && '${searchParameterForm.division.id}' !== "")
        {
            loadDistrict('${searchParameterForm.division.id}', $('#districtId'));
        } else if ('${searchParameterForm.isUpazilaAvailable}' === 'false' && '${searchParameterForm.district.id}' !== "")
        {
            loadUpazilla('${searchParameterForm.district.id}', $('#upazilaId'));
        } else if ('${searchParameterForm.isUnionAvailable}' === 'false' && '${searchParameterForm.upazila.id}' !== "")
        {
