...
<script type="text/javascript">
    $(function () {
        ...
        $(menuSelect("${pageContext.request.contextPath}/beneficiary/cityCorporation/list"));
...
//                    englishAlphabet: true
        ...
        {
            loadDistrictFromUpazilaTable('${beneficiaryForm.presentDistrict.id}', $('#presentUpazila'));
        } else if ('${beneficiaryForm.isUnionAvailable}' === 'false' && '${beneficiaryForm.presentUpazila.id}' !== "")
        {
            loadCityCorporation('${beneficiaryForm.presentUpazila.id}', $('#presentUnion'));
        }
...
//                    document.getElementById('profilePhotoFile').setAttribute ('src','data:image/jpeg;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==');
    ...
    function loadPermUpazilaList(selectObject) {
        ...
        if (distId !== '') {
            loadDistrictFromUpazilaTable(distId, upazillaSelectId, '${beneficiaryForm.permanentUpazila.id}');
        } else {
    ...
    function loadPresentUpazilaList(selectObject) {
        ...
        if (distId !== '') {
            loadDistrictFromUpazilaTable(distId, upazillaSelectId, '${beneficiaryForm.presentUpazila.id}');
        } else {
            resetSelect(upazillaSelectId);
            resetSelect($('#presentUnion'));
        }
    ...
    function loadPermUnionList(selectObject) {
        ...
        if (upazilaId !== '') {
            loadCityCorporation(upazilaId, unionSelectId, '${beneficiaryForm.permanentUnion.id}');
        } else {
    ...
    function loadPresentUnionList(selectObject) {
        ...
        if (upazilaId !== '') {
            loadCityCorporation(upazilaId, unionSelectId, '${beneficiaryForm.presentUnion.id}');
        } else {
            resetSelect(unionSelectId);
        }
    }
...
<form:form id="beneficiaryInfoForm" action="${actionUrl}" class="form-horizontal" enctype="multipart/form-data" role="form" modelAttribute="beneficiaryForm">
    <section class="content-header clearfix">
        <h1 class="pull-left">
            ...
            <small><i class="fa fa-arrow-circle-left"></i><a href="${contextPath}/beneficiary/cityCorporation/list"><spring:message code="label.backToList"/></a></small>
        </h1>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <form:input class="form-control" placeholder="${fullNameEn}" path="fullNameInEnglish" readonly="true" autofocus="autofocus" onkeydown="checkEnglishAlphabetWithLength(event, this, 60)"/>
                                    ...
                                    <div class="form-group" id="applicantTypeBlock" style="display: none">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 labelAsValue">
                                                <input type="radio" id="regularUser" name="applicantTypeRadio" <c:if test="${beneficiaryForm.applicantType eq 'REGULAR'}">checked</c:if>>&nbsp;<spring:message code="applicant.regular" />
                                                <input type="radio" id="bgmeaUser" name="applicantTypeRadio" <c:if test="${beneficiaryForm.applicantType eq 'BGMEA'}">checked</c:if>>&nbsp;<spring:message code="applicant.bgmea" />
                                                <input type="radio" id="bkmeaUser" name="applicantTypeRadio" <c:if test="${beneficiaryForm.applicantType eq 'BKMEA'}">checked</c:if>>&nbsp;<spring:message code="applicant.bkmea" />
                                                </div>
                                            </div>
                                        </div>
                                </c:if>
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        ...
                        <jsp:include page="beneficiarySocioEconomicInfoUrban.jsp"></jsp:include>  
                        </fieldset>
                    </div>    
                    <div class="col-md-6">
                        <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <form:input class="form-control" cssStyle="text-transform:uppercase" placeholder="${accountName}" path="accountName" readonly="true" autofocus="autofocus" onkeydown="checkEnglishAlphabetWithLength(event, this, 60)"/>
