...
<script type="text/javascript">
    $(function () {
        ...
        if ('${type}' === 'bgmea')
        {
            $(menuSelect("${pageContext.request.contextPath}/beneficiary/bgmea/list"));
        } else
        {
    ...
    <section class="content-header clearfix">
        <h1 class="pull-left">
            ...
            <small><i class="fa fa-arrow-circle-left"></i>
                <c:if test="${type eq 'bgmea'}"><a href="${contextPath}/beneficiary/bgmea/list"></c:if>
                    <c:if test="${type eq 'bkmea'}"><a href="${contextPath}/beneficiary/bkmea/list"></c:if>
                        <spring:message code="label.backToList"/></a></small>
        </h1>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <form:input class="form-control" placeholder="${fatherName}" path="fatherName" readonly="true" autofocus="autofocus" onkeydown="checkAlphabetWithLength(event, this, 30)"/>
                            ...
                            <div class="col-md-8">
                                ...
                                <form:input class="form-control" placeholder="${motherName}" path="motherName" readonly="true" autofocus="autofocus" onkeydown="checkAlphabetWithLength(event, this, 30)"/>
                        ...
                        <c:if test="${type eq 'bgmea'}">
                            <div class="form-group" id="bgmeaBlock">
                                ...
                                <c:choose>
                                    <c:when test="${beneficiaryForm.isBgmeaAvailable eq 'false'}">
                                        <div class="col-md-8">
                                            <spring:message code='label.select' var="select"/>
                                        ...
                                        <div class="col-md-8 labelAsValue">
                                            ...
                                            <c:choose>
                                                <c:when test="${pageContext.response.locale eq 'bn'}">
                                                    ${beneficiaryForm.bgmeaFactory.nameInBangla}
                                                </c:when>
                                                <c:otherwise>
                                                    ${beneficiaryForm.bgmeaFactory.nameInEnglish}
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </c:otherwise>
