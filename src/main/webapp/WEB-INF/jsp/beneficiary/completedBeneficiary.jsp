<%-- 
    Document   : completedBeneficiary
    Created on : Jun 27, 2021, 9:42:29 PM
                ...
                <div class="form-group">
                    <div class="col-md-6">    
                        <div class="form-group" id="periodDiv">
                            <label for="" class="col-md-4 control-label">অ্যাকাউন্ট ধরন  <span class="mandatory">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control" id="ddAccountType" onchange="accountTypeChange()">
                                    ...
                                    <option value="2">বাউন্স ব্যাক হয়েছে</option>
                                    <option value="3">বাউন্স ব্যাক সংশোধন</option>                                    
                                </select>
                            </div>  
                        </div>
                        <div class="form-group">
