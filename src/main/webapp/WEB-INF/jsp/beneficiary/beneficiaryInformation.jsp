...
<script type="text/javascript">
    $(function () {
        ...
        {
            $(menuSelect("${pageContext.request.contextPath}/beneficiary/list"));
        }        
...
<form:form id="beneficiaryInfoForm" action="${actionUrl}" class="form-horizontal" enctype="multipart/form-data" role="form" modelAttribute="beneficiaryForm">
    <section class="content-header clearfix">
        <h1 class="pull-left">
            ...
            <small><i class="fa fa-arrow-circle-left"></i><a href="${contextPath}/beneficiary/list"><spring:message code="label.backToList"/></a></small>
        </h1>
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <jsp:include page="beneficiarySocioEconomicInfo.jsp"></jsp:include>  
                        </fieldset>
                    </div>    
                    <div class="col-md-6">
                        <fieldset>
                ...
                <div class="col-md-12"> 
                    ...
                    <div class="col-md-6"> 
                        ...
                        <c:forEach items="${beneficiaryForm.attachmentList}" var="attachment" varStatus="index">                        
