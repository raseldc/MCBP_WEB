...
//        }
    ...
    function askSubmit()
    {
        var approvalMessage;
        if (selectedLocale === 'bn') {
            approvalMessage = "আবেদনকারী(দের)কে উপজেলা অনুমোদনের জন্য পাঠাতে চান?";
        } else
        {
            approvalMessage = "Are you sure you want to Forward The Applicant(s) For Upazila Approval?";
        }
...
//                    saveFormToCookie($('#fieldVerificationForm'));
    ...
    function loadPresentUpazilaList(selectObject) {
        ...
        if (distId !== '') {
            loadUpazillaWithDistrict(distId, upazillaSelectId);
        } else {
    ...
    <div class="form-group">      
        ...
        <div class="row">
            ...
            <div class="col-md-6" id="advanceBlock" style="display: none">
                <div>
                    <button class="btn bg-green" type="button" id="buttonAdvance" name="action" value="advance" onclick="return askSubmit();"><spring:message code="button.sendToUpazilaVerification" /></button>                    
