...
//        });
    ...
    {
        $.ajax({
            url: contextPath + "/checkMunicipalEligibility/" + $("#unionId").val(),
            type: "POST",
            async: false,
            dataType: "json",
...
//                }
    ...
    function askSubmit()
    {
        var approvalMessage;
        if (selectedLocale === 'bn') {
            approvalMessage = "আবেদনকারী(দের)কে জেলা অনুমোদনের জন্য পাঠাতে চান?";
        } else
        {
            approvalMessage = "Are you sure you want to Forward The Applicant(s) For District Approval?";
        }
    ...
    <div class="form-group">
                            ...
                            <div class="form-group">
                                <c:choose>
                                    <c:when test="${searchParameterForm.isUnionAvailable eq 'false'}">
                                        ...
                                        <div class="col-md-8">
                                            <spring:message code='label.select' var="select"/>
                                            <form:select class="form-control" path="union.id" id="unionId" name="unionId">
                                                <form:option value="" label="${select}"></form:option>
                                            </form:select>
                                    ...
                                    <c:otherwise>
                                        <label for="middleNameInput" class="col-md-4 control-label"><spring:message code="label.cityCorporation"/></label>
                                        <div class="col-md-8 labelAsValue">
        ...
        <div class="row">
            ...
            <div class="col-md-6" id="advanceBlock" style="display: none">
                <div>
                    <button class="btn bg-green" type="button" id="buttonAdvance" name="action" value="advance" onclick="return askSubmit();"><spring:message code="button.sendToDistrictVerification" /></button>                    
