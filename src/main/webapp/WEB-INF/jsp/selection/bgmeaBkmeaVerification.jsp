...
//        });
    ...
    function askSubmit()
    {
        ...
        var type = $("#applicantType").val();
        if (selectedLocale === 'bn') {
            approvalMessage = "আপনি কি ডিডব্লিউএ অফিসারের অনুমোদনের জন্য পাঠাতে চান?";
        } else
        {
            approvalMessage = "Are you sure you want to Forward The Applicant(s) For DWA Officer's Approval?";
        }
        bootbox.confirm({
            message: approvalMessage,
            buttons: {
...
<section class="content-header clearfix">
    <h1 class="pull-left">
        <c:if test="${type eq 'bgmea'}"><spring:message code="label.bgmeaRepresentativeAuditing" /></c:if>
        <c:if test="${type eq 'bkmea'}"><spring:message code="label.bkmeaRepresentativeAuditing" /></c:if>
        </h1>   
    </section>
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6" id="advanceBlock" style="display: none">
                <div>
                    <button class="btn bg-green" type="button" id="buttonAdvance" name="action" value="advance" onclick="return askSubmit();"><spring:message code="button.sendToDWAVerification" /></button>                    
