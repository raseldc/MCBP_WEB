  ...
  <nav class="site-nav dark js-site-navbar mb-5 site-navbar-target">
    <div class="container">
      <div class="site-navigation">
        <a href="index.html" class="logo m-0 float-left">Anunad<span class="text-primary">.</span></a>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 ml-auto"  data-aos="fade-up" data-aos-delay="200">
          <div class="quick-contact">
            ...
            <address class="text-black d-flex"><span class="mt-1 icon-room mr-2"></span><span>Mukto Bangla Shopping Complex, Space No-221 (8th Floor), Mirpur-1 , Dhaka</span></address>
            <ul class="list-unstyled ul-links mb-4">
            

              

              <li><a href="mailto:info@anunadsolution.com" class="d-flex"><span class="mt-1 icon-envelope mr-2"></span><span>info@anunadsolution.com</span></a></li>

              <li><a href="https://untree.co/" target="_blank" class="d-flex"><span class="mt-1 icon-globe mr-2"></span><span>http://aunadsolution.com/</span></a></li>
            </ul>
          </div>
        </div> <!-- /.col-lg-4 -->
      </div> <!-- /.row -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          <div class="widget">
            <h3>Quick Contact</h3>
            <address>Mukto Bangla Shopping Complex, Space No-221 (8th Floor), Mirpur-1 , Dhaka</address>
            <ul class="list-unstyled links mb-4">
              <li><a href="mailto:info@anunadsolution.com">info@anunadsolution.com</a></li>
            </ul>
          </div> <!-- /.widget -->
        </div> <!-- /.col-lg-3 -->
      ...
      <div class="row mt-5">
        <div class="col-12 text-center">
          <p class="copyright">Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love by Aunand Solution LTD</a>
          </p>
        </div>
      </div>
    </div> <!-- /.container -->
