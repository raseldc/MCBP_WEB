                ...
                <div class="box-body">
                    <form:form id="pendingListForm" class="form-horizontal" modelAttribute="searchParameterForm">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="upazila.id" class="col-md-4 control-label"><spring:message code="label.districtOrUpazila" /></label>
                                <c:choose>
                            ...
                            <div class="form-group">
                                <label for="union.id" class="col-md-4 control-label"><spring:message code="label.municipal" /></label>
                                <c:choose>
