...
<script>
    $(function () {
        ...
        {
            $(menuSelect("${pageContext.request.contextPath}/payroll/bgmea/create"));
        } else
        {
            $(menuSelect("${pageContext.request.contextPath}/payroll/bkmea/create"));
        }
        var urlLang = "";
                        ...
                        <div class="col-md-6">                                
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <button type="button" id="buttonSearchUnion" class="btn bg-blue"><span class="glyphicon glyphicon-search">&nbsp;</span><spring:message code="button.beneficiaryNumber" /></button>
                                </div>
                            </div>
                        </div>
