                ...
                <div class="form-group">
                    <div class="col-md-6">    
                        <div class="form-group" id="periodDiv">
                            <label for="" class="col-md-4 control-label"><spring:message code="paymentInfoUpdate.AccountType" />  <span class="mandatory">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control" id="ddAccountType" onchange="accountTypeChange()">
                                    <option value="0"><spring:message code="label.select" /></option>

                                    <option value="1"><spring:message code="paymentInfoUpdate.All" /></option>
                                    <option value="2"><spring:message code="paymentInfoUpdate.BounceBack" /></option>
                                    <option value="3"><spring:message code="paymentInfoUpdate.BounceBackCorrection" /></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="tbNid" name="nid" class="form-control" placeholder="${nid}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div id="regularBlock">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <form:select class="form-control" path="ward" id="ddWard" onchange="loadPresentVillageList(this)">
                                        <form:option value="0" label="${select}"></form:option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <button type="button" id="buttonSearch" class="btn bg-blue"><span class="glyphicon glyphicon-search">&nbsp;</span><spring:message code="viewReport"/></button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    function loadSearchResult() {
        ...
        if (form.valid()) {
            ...
            var table = $('#applicantListTable').DataTable({
                ...
                "ajax": baseUrl + "/beneficiary/paymentInformationViewDataTable?searchInfo=" + encodeURIComponent(JSON.stringify(serchInfo)),
...
//                        }},
                    ...
                    {"data": function (data) {
                            if (data.paymentCycleNameBN == undefined || data.paymentCycleNameEN == undefined)
                                return "un";
                            var accountNumber = selectedLocale === "bn" ? data.paymentCycleNameBN : data.paymentCycleNameEN;
                            return accountNumber;
                        }},
                    {"data": function (data) {
