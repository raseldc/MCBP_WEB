...
//            console.log('pc = ' + ${paymentGenerationForm.searchParameterForm.paymentCycle.id});
    ...
    function loadPaymentCycle(fiscalYearId, paymentCycleSelectId) {
        var ajaxUrl = contextPath + "/getAllPaymentCycle/" + fiscalYearId + "/3";
        $.ajax({
            type: "GET",
            url: ajaxUrl,
            async: false,
...
<form:form id="paymentListForm" action="${contextPath}/payment/statusupdate/" class="form-horizontal" modelAttribute="searchParameterForm">
