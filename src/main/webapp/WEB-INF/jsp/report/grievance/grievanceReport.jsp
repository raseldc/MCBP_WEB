...
<form:form action="${contextPath}/grievanceReport" method="post" target="_blank" class="form-horizontal" id="reportForm" modelAttribute="reportParameterForm" >
    <section class="content-header clearfix">
        <h1 class="pull-left">
            <spring:message code='reportHeader.grievanceReport'/>
        </h1>
    </section>    
...
<!--                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <spring:message code='label.select' var="select"/>
                            <form:select class="form-control" path="scheme.id"  id="scheme" autofocus="autofocus"> 
