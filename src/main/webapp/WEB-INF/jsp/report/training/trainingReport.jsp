...
<script>
    $(function () {
        ...
        initDate($("#startDate"), '${dateFormat}', $("#startDate\\.icon"));
        initDate($("#endDate"), '${dateFormat}', $("#endDate\\.icon"));
        $("#reportForm").validate({
            rules: {// checks 
                "scheme.id": {
                    required: true
...
<form:form action="${contextPath}/trainingReport" method="post" target="_blank" class="form-horizontal" id="reportForm" modelAttribute="reportParameterForm" >
    <section class="content-header clearfix">
        <h1 class="pull-left">
            <spring:message code='reportHeader.trainingReport'/>
        </h1>
    </section>    
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="startDate" class="col-md-4 control-label"><spring:message code="training.startDate" /></label>
                        <div class="col-md-8">
                            <spring:message code='training.startDate' var="startDate"/>
                            <form:input class="form-control" placeholder="${startDate}" path="startDate" id="startDate"/>
                            <form:errors path="startDate" cssStyle="color:red"></form:errors>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="endDate" class="col-md-4 control-label"><spring:message code="training.endDate" /></label>
                        <div class="col-md-8">
                            <spring:message code='training.endDate' var="endDate"/>
                            <form:input class="form-control" placeholder="${endDate}" path="endDate" id="endDate"/>
