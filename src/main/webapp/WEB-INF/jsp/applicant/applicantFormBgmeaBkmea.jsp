...
//    var upazilaList = [114, 662, 8134, 8527, 9141, 395, 7263];
    ...
    $(function () {
        ...
        if ('${actionType}' === 'create')
        {
            if ('${type}' === 'bgmea')
            {
                $(menuSelect("${pageContext.request.contextPath}/applicant/bgmea/create"));
            } else
            {
                $(menuSelect("${pageContext.request.contextPath}/applicant/bkmea/create"));
            }
        } else
        {
            if ('${type}' === 'bgmea')
            {
                $(menuSelect("${pageContext.request.contextPath}/applicant/bgmea/list"));
            } else
            {
                $(menuSelect("${pageContext.request.contextPath}/applicant/bkmea/list"));
            }
        }
...
//                        isExistOtherMIS('<spring:message code="label.failure" />', '<spring:message code="label.ok" />');
                    ...
                    $('#accountName').val(response.nidData.nameEn);
                } else {
                    bootbox.dialog({
                        onEscape: function () {},
                        title: '<spring:message code="label.failure" />',
    ...
    <section class="content-header clearfix">
        <h1 class="pull-left">
            ...
            <small><i class="fa fa-arrow-circle-left"></i>
                <c:if test="${type eq 'bgmea'}"><a href="${contextPath}/applicant/bgmea/list"></c:if>
                    <c:if test="${type eq 'bkmea'}"><a href="${contextPath}/applicant/bkmea/list"></c:if>
                    ...
                    <div class="col-md-6 one-column-left-legend">
                        ...
                        <c:if test="${type eq 'bgmea'}">
                            <div class="form-group" id="bgmeaBlock">
                                ...
                                <c:choose>
                                    <c:when test="${applicantForm.isBgmeaAvailable eq 'false'}">
                                        <div class="col-md-8">
                                            <spring:message code='label.select' var="select"/>
                                        ...
                                        <div class="col-md-8 labelAsValue">
                                            ...
                                            <c:choose>
                                                <c:when test="${pageContext.response.locale eq 'bn'}">
                                                    ${applicantForm.bgmeaFactory.nameInBangla}
                                                </c:when>
                                                <c:otherwise>
                                                    ${applicantForm.bgmeaFactory.nameInEnglish}
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </c:otherwise>
                        ...
                        <c:if test="${type eq 'bkmea'}">
                            <div class="form-group" id="bgmeaBlock">
                                ...
                                <c:choose>
                                    <c:when test="${applicantForm.isBkmeaAvailable eq 'false'}">
                                        <div class="col-md-8">
                                            <spring:message code='label.select' var="select"/>
                                    ...
                                    <c:otherwise>
                                        <div class="col-md-8 labelAsValue">
                                            ...
                                            <c:choose>
                                                <c:when test="${pageContext.response.locale eq 'bn'}">
                                                    ${applicantForm.bkmeaFactory.nameInBangla}
                                                </c:when>
                                                <c:otherwise>
                                                    ${applicantForm.bkmeaFactory.nameInEnglish}
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </c:otherwise>
