...
<div class="form-group">
    ...
    <div class="form-group">
        <label for="occupationRural" class="col-md-4 control-label"><spring:message code="label.husbandOccupation" /><span class="mandatory">*</span></label>
    <div class="col-md-8">
    ...
    <div class="form-group">
        <label for="isHHWallPoorRural" class="col-md-4 control-label"><spring:message code="label.hhWallMadeOf" /><span class="mandatory">*</span></label>
    <div class="col-md-8">
