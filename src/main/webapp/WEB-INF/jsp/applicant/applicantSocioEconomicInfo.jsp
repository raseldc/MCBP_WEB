...
<div class="form-group">
    <label for="iSFirstEarner" class="col-md-4 control-label"><spring:message code="label.iSFirstEarner" /><span class="mandatory">*</span></label>
    <div class="col-md-8">
...
<div class="form-group">
    ...
    <div class="col-md-8">
        ...
        <form:input class="form-control" placeholder="${monthlyIncome}" path="monthlyIncome" onkeydown="checkNumberWithLength(event, this, 4)"/>
