...
<div class="box">
    <div class="box-header" style="border-top:1px solid lightgray; border-bottom:1px solid lightgray">
        <c:if test="${becResponse.matchFound == true}">
            <div class="col-md-6">
                <b><spring:message code="label.nid" />:&nbsp;</b><span id="applicantNid"><c:out value="${applicant.nid}"></c:out></span>
                </div>
            ...
            <table id="comparisonTable" class="table table-bordered table-hover">
                <thead style="background-color: #EEE">
                    <tr>
                        ...
                        <th style="width: 40%"><spring:message code="label.applicantInfo" /></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${pageContext.response.locale eq 'en'}">
                                <c:out value="${applicant.presentAddressLine1}, ${applicant.presentUnion.nameInEnglish}, ${applicant.presentUpazila.nameInEnglish}, ${applicant.presentDistrict.nameInEnglish}"></c:out>
                            </c:if>
                            <c:if test="${pageContext.response.locale eq 'bn'}">
                                <c:out value="${applicant.presentAddressLine1}, ${applicant.presentUnion.nameInBangla}, ${applicant.presentUpazila.nameInBangla}, ${applicant.presentDistrict.nameInBangla}"></c:out>
                            </c:if>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${pageContext.response.locale eq 'en'}">
                                <c:out value="${applicant.permanentAddressLine1}, ${applicant.permanentUnion.nameInEnglish}, ${applicant.permanentUpazila.nameInEnglish}, ${applicant.permanentDistrict.nameInEnglish}"></c:out>
                            </c:if>
                            <c:if test="${pageContext.response.locale eq 'bn'}">
                                <c:out value="${applicant.permanentAddressLine1}, ${applicant.permanentUnion.nameInBangla}, ${applicant.permanentUpazila.nameInBangla}, ${applicant.permanentDistrict.nameInBangla}"></c:out>
                            </c:if>
                        </td>
