...
<script type="text/javascript">
    ...
    $(function () {
        ...
        includeJs(contextPath + "/resources/js/utility.js?v1=${asset}");
...
//                    englishAlphabet: true
        ...
        $("#signatureInput").fileinput({
            overwriteInitial: true,
            maxFileSize: 100,
            initialCaption: "The Moon and the Earth"
        });

        $("#multipartFileList0").fileinput({
            overwriteInitial: true,
            maxFileSize: 100,
            initialCaption: "The Moon and the Earth"
        });
            ...
            success: function (response) {
                ...
                if (response == null || response == "")
                {
                    ...
                    if (response.nidData.gender == "male")
                    {
                        ...
                        var fullNameInBan = response.nidData.name === "null" ? "" : response.nidData.name;
                        fullNameInBan = fullNameInBan.replca
                        $('#fullNameInBangla').val(response.nidData.name === "null" ? "" : replaceSpecialChar(response.nidData.name));
                        $('#fullNameInEnglish').val(response.nidData.nameEn === "null" ? "" : replaceSpecialChar(response.nidData.nameEn));
                        $('#fatherName').val(response.nidData.father === "null" ? "" : response.nidData.father);
                        $('#motherName').val(response.nidData.mother === "null" ? "" : response.nidData.mother);
...
//                        onEscape: function () {},
//                        title: '<spring:message code="label.failure" />',
//                        message: "দরিদ্র মা'র জন্য মাতৃত্বকাল ভাতা ভাতাভোগী 12",
//                        buttons: {
//                            ok: {
//                                label: '<i class="fa fa-check"></i> <spring:message code="label.ok" />'
//                            }
...
//        }
    ...
    function loadPresentVillageList(selectObject) {
        ...
        if (unionId !== '' && wardNo !== '') {
            loadVillage(unionId, wardNo, villageSelectId, '${applicantForm.presentVillage.id}');
        } else {
    ...
    function loadPermanentVillageList(selectObject) {
        ...
        if (unionId !== '' && wardNo !== '') {
            loadVillage(unionId, wardNo, villageSelectId, '${applicantForm.permanentVillage.id}');
        } else {
            resetSelect(villageSelectId);
        }
    }
...
//        $("#permanentWardNo").attr("disabled", value);
    ...
    function loadBranchList(selectObject) {
        ...
        if (idName == "mobileBankingProvider")
        {
            ...
            if (accountNoLength == "-1" || accountNoLength == "undefined") {
                accountNoLength = 100;
            ...
            <div class="col-md-12 one-column-legend">
                    ...
                    <div class="col-md-6 one-column-left-legend">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <form:input class="form-control" placeholder="${fullNameEn}" path="fullNameInEnglish"   readonly="true"/>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="middleNameInput" class="col-md-4 control-label">
                                <spring:message code="label.upazila" /><span class="mandatory">*</span></label>
                            <div class="col-md-8">
                                <spring:message code='label.select' var="select"/>
                            ...
                            <div class="form-group">
                                <label for="middleNameInput" class="col-md-4 control-label">
                                <spring:message code="label.union" /><span class="mandatory">*</span></label>
                            <div class="col-md-8">                                
                                <spring:message code='label.select' var="select"/>
                ...
                <div class="col-md-12"> 
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <h4 style="background-color: red" >প্রতিটি ফাইলের সাইজ ১০০কিলোবাইটের মধ্যে রাখুন। </h4>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <div id="photo">
                                    <input id="photoInput" name="photo" type="file" class="file" 
                                           accept="image/jpg,image/png,image/jpeg,image/gif" data-allowed-file-extensions='["jpg", "jpeg", "png", "gif"]'>
                                </div>
