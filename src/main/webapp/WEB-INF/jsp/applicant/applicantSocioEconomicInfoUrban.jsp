...
<div class="form-group">
    ...
    <div class="col-md-8">
        <form:select class="form-control" path="occupationUrban">
            <c:if test="${applicantForm.applicantType ne 'BGMEA' && applicantForm.applicantType ne 'BKMEA'}">
                <form:option value="" label="${select}"></form:option>
            </c:if> 
    ...
    <div class="form-group">
        <label for="hASElectricFanUrban" class="col-md-4 control-label"><spring:message code="label.hASElectricFan" /><span class="mandatory">*</span></label>
    <div class="col-md-8">
