...
<script>
    $(document).ready(function () {
        ...
        if ("${message.message}")
        {
            ...
            loadFormFromCookie($('#bkmeaFactoryListForm'));
            search();
        }
        ...
        function search()
        {
            saveFormToCookie($('#bkmeaFactoryListForm'));
            $('#bkmeaFactoryListTable').DataTable().destroy();
            $('#bkmeaFactoryListTable').DataTable({
                "processing": true,
                "pageLength": 10,
                ...
                "fnDrawCallback": function (oSettings) {
                    ...
                    {
                        localizeBanglaInDatatable("bkmeaFactoryListTable");
                    }
                }
            });
        }
...
<form:form id="bkmeaFactoryListForm" action="${actionUrl}" method="post" class="form-horizontal" role="form" modelAttribute="searchParameterForm">
    <section class="content-header clearfix">
        <h1 class="pull-left">
            <spring:message code="label.bkmeaFactory" />&nbsp;<spring:message code="label.list" />
            <small></small>
        </h1>
        <div class="pull-right">
            <a href="${contextPath}/factory/bkmea/create" class="btn bg-blue">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-body">
                            <table id="bkmeaFactoryListTable" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
