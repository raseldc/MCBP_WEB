...
//        });
        ...
        {
            $("#unionListForm").validate();
            if ($("#unionListForm").valid())
            {
                $('#unionListTable').DataTable().destroy();
                $('#unionListTable').DataTable({
                    "processing": true,
                    "pageLength": 10,
                    ...
                    "fnDrawCallback": function (oSettings) {
                        ...
                        {
                            localizeBanglaInDatatable("unionListTable");
                        }
                    }
                });
            }
...
<form:form id="unionListForm" action="${actionUrl}" method="post" class="form-horizontal" role="form" modelAttribute="searchParameterForm">
    <section class="content-header clearfix">
        <h1 class="pull-left">
            <spring:message code="label.union" />&nbsp;<spring:message code="label.list" />
            <small></small>
        </h1>
        <div class="pull-right">
            <a href="${contextPath}/union/create" class="btn bg-blue">
    ...
    <section class="content">
        <div class="form-group">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <label for="unionName" class="col-md-4 control-label"><spring:message code="label.name" /></label>
                    <div class="col-md-8">

                        <input class="form-control" placeholder="${unionNameInputBangla}" id="unionName"/>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <table id="unionListTable" class="table table-bordered table-hover">
                            <thead>
                                <tr>
